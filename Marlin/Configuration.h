...
#define CUSTOM_MACHINE_NAME "Torbjorn"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79, 79, 405, 99 }
...
#define MANUAL_Z_HOME_POS -0.4 // Distance between the nozzle to printbed after homing
